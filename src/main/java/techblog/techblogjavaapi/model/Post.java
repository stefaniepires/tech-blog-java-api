...
public class Post {
    ...
    @NotNull //not allowed to be null in db
    @Temporal(TemporalType.DATE) //allows use of date in the db and tells JPA this will house date data type
    @Column(name = "updated_at") //this is the name of the column for the db
